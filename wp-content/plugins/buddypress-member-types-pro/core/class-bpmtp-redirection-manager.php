...
class BPMTP_Redirection_manager {
	...
	public function setup() {
		add_action( 'login_redirect', array( $this, 'login_redirect' ), 111,3 );
	 ...
	 *
	 * @param string $redirect_to_calculated
	 * @param string $redirect_url_specified
	...
	private function get_redirect_url( $user_id, $type = 'login' ) {
		...
		$dynamic_url = 'login' === $type ? $mtp_details->login_redirect_url : $mtp_details->activation_redirect_url;
