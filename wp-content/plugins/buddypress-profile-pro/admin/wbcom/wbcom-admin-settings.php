	...
	class Wbcom_Admin_Settings {
		...
		public function wbcom_enqueue_admin_scripts() {
			...
			if ( !wp_script_is( 'wbcom-admin-setting-js', 'enqueued' ) ) {
				...
				wp_register_script(
				$handle		 = 'wbcom_admin_setting_js', $src		 = WBBPP_PLUGIN_URL . 'admin/wbcom/assets/js/wbcom-admin-setting.js', $deps		 = array( 'jquery' ), $ver		 = time(), $in_footer	 = true
				);
				wp_localize_script(
			...
			if ( function_exists( 'get_current_screen' ) ) {
				...
				if ( 'toplevel_page_wbcomplugins' === $screen->base ) {
					...
					if ( !wp_script_is( 'buddypress-profile-pro', 'enqueued' ) ) {
						wp_enqueue_script( 'buddypress-profile-pro', WBBPP_PLUGIN_URL . 'admin/js/buddypress-profile-pro-admin.js', array( 'jquery' ) );
					}
					if ( !wp_style_is( 'buddypress-profile-pro', 'enqueued' ) ) {
						wp_enqueue_style( 'buddypress-profile-pro', WBBPP_PLUGIN_URL . 'admin/css/buddypress-profile-pro-admin.css', array(), time(), 'all' );
					}
				}
			}
		}
