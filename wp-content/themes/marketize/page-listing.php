        ...
        <div id="tab1" class="tab active">
            <div class="listing-header-content ">
                <div class="container listing-header">
                    <h1 class="corrected"><?php the_field('property_name'); ?></h1>
                    <h2 class="corrected"><?php the_field('property_subtitle'); ?></h2>
                     <?php if( !empty($property_logo) ): ?>
                            <img src="<?php echo $property_logo['url']; ?>" alt="<?php echo $property_logo['alt']; ?>" />
                    <?php endif; ?>
                    
<!--**** PLEASE ADD THE DYNAMIC TYPING FIELD FOR NEAREST TOWN -->
                    <p>Situated in the <?php the_field('nearest_town'); ?> district </p> 
<!--**** PLEASE ADD THE DYNAMIC TYPING FIELD FOR ADDRES COORDINATES-->
<!--**** PLEASE ADD THE PROVINCE FIELD FORM THE ADDRESS COORDINATES BELOW AND REMOVE ACF-->                      
                    <p>in&nbsp;the&nbsp;<?php the_field('province'); ?></p>
...
<!-- WINGSHOOTING TAB 4 -->                       
<?php if( in_array( 'Wingshooting', get_field('property_disciplines') ) or 'Wingshooting' == get_field('property_disciplines') ) { ?>                
...
<?php }  ?>                       
 <!-- ANGLING TAB 5 --> 
                <?php if( in_array( 'Angling', get_field('property_disciplines') ) or 'Angling' == get_field('property_disciplines') ) { ?>   
                    <!-- DISPLAY FISH IN TAB -->
            ...
            <div id="listing-body" class="">
                ...
                <div id="terrain-container" class="container">
                    ...
                    <div class="ww-styling">
                        <?php if( get_field('terrain_description') ): the_field('terrain_description'); endif; ?>                        
                    </div>
                </div> 
                                    ...
                                    <div class="light-listing-col">
                                       <h3 class="accordion">HUNTING<i class="fa fa-plus"></i><i class="fa fa-minus"></i></h3>
                                        <ul class="panel">                                    
                                            ...
                                            ?>                                    
                                                <li><?php the_sub_field('hunting_day_fees') ?><span><?php the_sub_field('day_fees_price') ?></span></li>
                                            <?php endwhile; ?>                                            
                                        </ul>                        
                                    </div>  
                                    ...
                                    <div class="light-listing-col">
                                       <h3 class="accordion">WINGSHOOTING<i class="fa fa-plus"></i><i class="fa fa-minus"></i></h3>
                                        <ul class="panel">                                    
                                            ...
                                            ?>                                    
                                                <li><?php the_sub_field('wing_day_fees') ?><span><?php the_sub_field('wing_day_price') ?></span></li>
                                            <?php endwhile; ?>                                            
                                        </ul>                        
                                    </div>  
                                <?php  else : // no rows found
...
<!--**** WE NEED TO CREATE AN ACTUAL FORM HERE FOR THE T&C TO LINK TO -->                                   
  ...
  <!--**** PLEASE DIVID ANIMAL COLUMUNS BY 2 -I WILL MERG THE VIA CSS ON MOBILE -->                    
                                    ...
                                    <div class="animal-listing-col">
                                        <table>   
                                            ...
                                            ?>                                    
                                                ...
                                                <td>R: <span><?php the_sub_field('animal_price') ?></span></td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <th>PRICE</th>                                            
                                                               ...
                                                               <tr>
                                                                    ...
                                                                    <td>R: <span><?php the_sub_field('bird_price') ?></span></td>
                                                                </tr> 
                                                                    <?php endwhile; ?>  
                                                        ...
                                                        <tr>
                                                            ...
                                                            <th>PRICE</th>                                            
                                                               ...
                                                               <tr>
                                                                    ...
                                                                    <td><?php the_sub_field('fish_price') ?></td>
                                                                </tr> 
                                                                    <?php endwhile; ?>  
