...
class BP_XProfile_Field_Type_Radiobutton extends BP_XProfile_Field_Type {
	...
	public function __construct() {
		...
		$this->name     = _x( 'Terms_conditions', 'xprofile field type', 'buddypress' );
		 ...
		 */
		do_action( 'bp_xprofile_field_type_termsconditions', $this );
	}
	...
	public function edit_field_options_html( array $args = array() ) {
		...
		for ( $k = 0, $count = count( $options ); $k < $count; ++$k ) {
			 ...
			 */
			$html .= apply_filters( 'bp_get_the_profile_field_options_termsconditions', $new_html, $options[$k], $this->field_obj->id, $selected, $k );
		}
	...
	public function admin_new_field_html( BP_XProfile_Field $current_field, $control_type = '' ) {
		parent::admin_new_field_html( $current_field, 'termsconditions' );
	}
}
